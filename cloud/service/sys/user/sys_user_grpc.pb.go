...
func (UnimplementedSysUserServiceServer) SysUserListTotal(context.Context, *SysUserListTotalRequest) (*SysUserTotalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SysUserListTotal not implemented")
}
func (UnimplementedSysUserServiceServer) SysUserScope(context.Context, *SysUserScopeRequest) (*SysUserScopeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SysUserScope not implemented")
}
func (UnimplementedSysUserServiceServer) SysUserPassword(context.Context, *SysUserPasswordRequest) (*SysUserPasswordResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SysUserPassword not implemented")
}
...
func RegisterSysUserServiceServer(s grpc.ServiceRegistrar, srv SysUserServiceServer) {
	// If the following call panics, it indicates UnimplementedSysUserServiceServer was
