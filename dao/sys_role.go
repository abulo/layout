...
type SysRole struct {
	...
	DataScope     null.Int32    `gorm:"column:data_scope" json:"dataScope"`           //tinyint 数据范围:1:全部数据权限/2:自定数据权限/3:本部门数据权限/4:本部门及以下数据权限
	DataScopeDept null.JSON     `gorm:"column:data_scope_dept" json:"dataScopeDept"`  //json 数据范围(指定部门数组)
